 ...
 */
public class myMTKeyboard extends MTRoundRectangle implements IKeyListener {
	 ...
	 */
	public myMTKeyboard(PApplet pApplet) {
		...
		keyFont = FontManager.getInstance().createFont(pa, 
				/*"geneva-webfont.svg"*/"arial.ttf", 2, keyColor); 
...
//			System.out.println(SpaceF.getDisplayListIDs()[0] + "  - " + SpaceF.getDisplayListIDs()[1]);
			space.getGeometryInfo().setDisplayListIDs(SpaceF.getGeometryInfo().getDisplayListIDs()); //Wenn nicht displaylisten, mÔøΩssen wir geometry auch ÔøΩbernehmen!
...
//            tp.setLockPriority(1.5f); 
	...
	private KeyInfo[] getKeysLayout(){
	    ...
	    */
	    ...
	    }else if (l.getLanguage().equalsIgnoreCase(Locale.FRANCE.getLanguage())){
...
//		keyInfos.add(new KeyInfo("^", "^", "^", new Vector3D(startX,lineY), 			  KeyInfo.NORMAL_KEY)); //ESC key
		...
		keyInfos.add(new KeyInfo("é", "é", "é", new Vector3D(startX+2*advanceMent,lineY), KeyInfo.KEY_ONLY_VISIBLE_WHEN_SHIFT_PRESSED));
		...
		keyInfos.add(new KeyInfo("è", "è", "è", new Vector3D(startX+7*advanceMent,lineY), KeyInfo.KEY_ONLY_VISIBLE_WHEN_SHIFT_PRESSED));
		...
		keyInfos.add(new KeyInfo("ç", "ç", "ç", new Vector3D(startX+9*advanceMent,lineY), KeyInfo.KEY_ONLY_VISIBLE_WHEN_SHIFT_PRESSED));
		
		keyInfos.add(new KeyInfo("0", "0", "0", new Vector3D(startX+10*advanceMent,lineY), KeyInfo.KEY_ONLY_VISIBLE_WHEN_SHIFT_NOTPRESSED));
		keyInfos.add(new KeyInfo("à", "à", "à", new Vector3D(startX+10*advanceMent,lineY), KeyInfo.KEY_ONLY_VISIBLE_WHEN_SHIFT_PRESSED));
		...
		keyInfos.add(new KeyInfo("*", "*", "_", new Vector3D(startX+12*advanceMent,lineY), KeyInfo.KEY_ONLY_VISIBLE_WHEN_SHIFT_PRESSED));
		...
		keyInfos.add(new KeyInfo("ù", "ù", "%", new Vector3D(startX+8*advanceMent,lineY), KeyInfo.NORMAL_KEY));
...
//		keyInfos.add(new KeyInfo("^", "^", "^", new Vector3D(startX,lineY), 			  KeyInfo.NORMAL_KEY)); //ESC key
		...
		keyInfos.add(new KeyInfo("L", "l", "L", new Vector3D(startX+8*advanceMent,lineY),  KeyInfo.NORMAL_KEY));
		//÷
		keyInfos.add(new KeyInfo("1111", "ˆ", "÷", new Vector3D(startX+9*advanceMent,lineY),  KeyInfo.NORMAL_KEY));
		//ƒ
        keyInfos.add(new KeyInfo("11", "‰", "ƒ", new Vector3D(startX+10*advanceMent,lineY),  KeyInfo.NORMAL_KEY));
...
//		keyInfos.add(new KeyInfo("^", "^", "^", new Vector3D(startX,lineY), 			  KeyInfo.NORMAL_KEY)); //ESC key
		...
		keyInfos.add(new KeyInfo("P", "p", "P", new Vector3D(startX+10*advanceMent,lineY), KeyInfo.NORMAL_KEY));
		//ÔøΩ
//		keyInfos.add(new KeyInfo("111", "ÔøΩ", "ÔøΩ", new Vector3D(startX+11*advanceMent,lineY), KeyInfo.NORMAL_KEY));
		...
		keyInfos.add(new KeyInfo("L", "l", "L", new Vector3D(startX+8*advanceMent,lineY),  KeyInfo.NORMAL_KEY));
		//ÔøΩ
//		keyInfos.add(new KeyInfo("1111", "ÔøΩ", "ÔøΩ", new Vector3D(startX+9*advanceMent,lineY),  KeyInfo.NORMAL_KEY));
		//ÔøΩ
//		keyInfos.add(new KeyInfo("11", "ÔøΩ", "ÔøΩ", new Vector3D(startX+10*advanceMent,lineY),  KeyInfo.NORMAL_KEY));
