...
import org.mt4jx.components.visibleComponents.widgets.pdf.CachedPDFPageLoader;
import org.mt4jx.components.visibleComponents.widgets.pdf.PDFRenderer;
import org.mt4jx.components.visibleComponents.widgets.pdf.PrefetchThread;
import org.mt4jx.components.visibleComponents.widgets.pdf.RenderedPDFPage;
import org.mt4jx.components.visibleComponents.widgets.pdf.ThreadAndPreDrawAction;
...
public class myMTPDF extends MTRectangle {
	...
	public PropertyChangeSupport pdfPCSupport=new PropertyChangeSupport(this);
	...
	public Image getPreviewOfPage(int pn){
		int pnumber;
		if(pn<1){
			pnumber = 1;
		}else{
...
//		try {
	...
	public myMTPDF(PApplet app, File pdf){
		this(app, pdf, 1);
		this.app = app;
	}
	public myMTPDF(PApplet pApplet, File pdf, int pageNumber){
		super(pApplet,0,0);
		this.pdf = pdf;
		this.app = pApplet;
