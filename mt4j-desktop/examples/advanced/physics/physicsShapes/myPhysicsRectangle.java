...
public class myPhysicsRectangle extends MTRectangle implements IPhysicsComponent{
	private float angle;
...
//		theBody.setBullet(true);
	...
	public myPhysicsRectangle(PImage texture, 
			Vector3D pos, 
			PApplet applet,
...
//				app.noFill();
	...
	public void rotateZLocal(float degree) {
		super.rotateZ(this.getCenterPointLocal(),degree, TransformSpace.LOCAL);
		//angle -= degree;
	} 
